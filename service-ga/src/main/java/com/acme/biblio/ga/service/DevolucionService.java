...
public class DevolucionService {
    ...
    public Prestamo procesarDevolucion(String usuarioId, String libroId, String sedeOrigen) {
        ...
        // 1) Idempotencia básica por operación + usuario + libro
        ...
        // 2) Buscar préstamo ACTIVO para ese usuario y libro
        ...
        // 3) Marcar el préstamo como devuelto
        prestamo.setEstado("DEV");
        prestamoRepo.save(prestamo);

        // 4) Actualizar stock en LIBRO según sede de origen
        ...
        // 5) Registrar idempotencia de la operación
        ...
        // Futuro: aquí podríamos registrar un evento DevolucionRecibidaEvt en GA_OUTBOX
